...
class CardView<ShapeType: ShapeLayerProtocol>: UIView, FlippableView {
    ...
    func flip() {
        let viewFrom = isFlipped ? frontSideView : backSideView
        let viewTo = isFlipped ? backSideView : frontSideView
        
        UIView.transition(from: viewFrom, to: viewTo, duration: 0.5, options: .transitionFlipFromTop) { _ in
